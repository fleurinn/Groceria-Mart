...
<!-- Menu Navigasi Khusus Order -->
<div class="bg-[#fff] border-t border-b border-[#eee]">
    <div class="gi-main-menu flex">
        <ul class="w-full flex justify-center flex-wrap pl-[0]">
            <li onclick="showTab('semua')" id="tab-semua" class="mx-[20px] text-[15px] leading-[60px] capitalize text-[#4b5966] font-medium">
                Semua
            </li>
            <li onclick="showTab('dikemas')" id="tab-dikemas" class="mx-[20px] text-[15px] leading-[60px] capitalize text-[#4b5966] font-medium">
                Dikemas
            </li>
            <li onclick="showTab('dikirim')" id="tab-dikirim" class="mx-[20px] text-[15px] leading-[60px] capitalize text-[#4b5966] font-medium">
                Dikirim
            </li>
            <li onclick="showTab('untuk diulas')" id="tab-dikirim" class="mx-[20px] text-[15px] leading-[60px] capitalize text-[#4b5966] font-medium">
                Untuk Diulas
            </li>
        </ul>
    </div>
...
<!-- semua section -->
    <section id="content-semua" class="tab-content" class="gi-category py-[40px] max-[767px]:py-[30px]">
...
<!-- semua section -->
<section id="content-dikemas" class="tab-content hidden" class="gi-category py-[40px] max-[767px]:py-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            <div class="flex flex-wrap w-full">
                    <!-- Shop content Start -->
                    <div class="shop-pro-content">
...
<!-- semua section -->
<section id="content-dikirim" class="tab-content hidden" class="gi-category py-[40px] max-[767px]:py-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            <div class="flex flex-wrap w-full">
                    <!-- Shop content Start -->
                    <div class="shop-pro-content">
...
<!-- semua section End -->
<!-- semua section -->
<section id="content-diulas" class="tab-content hidden" class="gi-category py-[40px] max-[767px]:py-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            <div class="flex flex-wrap w-full">
                    <!-- Shop content Start -->
                    <div class="shop-pro-content">
...
function showTab(tabId) {
  const tabs = ['semua', 'dikemas', 'dikirim', 'diulas'];
