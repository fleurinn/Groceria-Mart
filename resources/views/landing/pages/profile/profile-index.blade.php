                            ...
                            <div class="gi-register-form">  
                                <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data" class="flex flex-row flex-wrap mx-[-15px]">
                                    ...
                                    <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                        ...
                                        <input value="{{ old('first_name', $user->first_name) }}" type="text" name="first_name" placeholder="Masukan nama depan" class="w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]" required readonly>
                                    </span>
                                    <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                        <label class="inline-block mb-[9px] text-[#4b5966] text-[15px] font-medium tracking-[0] leading-[1]">Nama Belakang*</label>
                                        <input value="{{ old('last_name', $user->last_name) }}" type="text" name="last_name" placeholder="Masukan nama belakang" class="w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]" required readonly>
                                    </span>
                                    <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                        <label class="inline-block mb-[9px] text-[#4b5966] text-[15px] font-medium tracking-[0] leading-[1]">Nama Lengkap*</label>
                                        <input value="{{ old('name', $user->name) }}" type="text" name="name" placeholder="Masukan nama lengkap" class="w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]" required readonly>
                                    </span>
                                    <span class="gi-register-wrap gi-register-half w-[50%] px-[15px]">
                                        <label class="inline-block mb-[9px] text-[#4b5966] text-[15px] font-medium tracking-[0] leading-[1]">Email*</label>
                                        <input value="{{ old('email', $user->email) }}" type="email" name="email" placeholder="Masukan email anda..." class="w-full bg-transparent border-[1px] border-solid border-[#eee] text-[#777] text-[14px] mb-[26px] px-[15px] outline-[0] rounded-[5px] h-[50px]" required readonly>
                                    </span>
                                    <span class="gi-register-wrap w-full px-[15px]">
                                        ...
                                        <div class="w-full md:w-1/2 px-[15px]">
                                            ...
                                            <input type="text" name="shipping_addresses[0][address]" value="{{ old('shipping_addresses.0.address', $user->shippingAddress->address ?? '') }}" class="w-full h-[50px] mb-[30px] px-[10px] rounded-[5px] border border-[#eee] text-[14px] text-[#777] font-light" readonly>
                                        </div>
