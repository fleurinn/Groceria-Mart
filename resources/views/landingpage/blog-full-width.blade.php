...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/blog-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:51 GMT -->
                    ...
                    <div class="grow-[1] shrink-[0] basis-[0%] min-[992px]:hidden">
                        <div class="gi-header-bottons flex justify-end">
                            <div class="right-icons flex flex-row">
                                <!-- Header User Start -->
                                <a href="{{ url('/login') }}"
                                    class="gi-header-btn gi-header-user mr-[30px] relative transition-all duration-300 ease-in-out flex text-[#4b5966] w-auto items-center">
                                ...
                                <a href="{{ url('/wishlist') }}"
                                    class="gi-header-btn gi-wish-toggle mr-7 relative transition-all duration-300 ease-in-out flex text-[#4b5966] w-auto items-center">
                                ...
                                <a href="javascript:void(0)"
                                    ...
                                    <span
                                        class="gi-header-count gi-cart-count w-[15px] h-[15px] text-[#fff] flex items-center justify-center rounded-full text-[11px] absolute top-[-2px] right-[-6px] opacity-80">3</span>
                                </a>
                                <!-- Header Cart End -->

                                <!-- Header menu Start -->
                                <a href="javascript:void(0)"
                                    class="gi-header-btn gi-site-menu-icon relative transition-all duration-300 ease-in-out flex text-[#4b5966] w-auto items-center">
                                    <i class="fi-rr-menu-burger text-2xl leading-[17px]"></i>
                                </a>
                                <!-- Header menu End -->
                    ...
                    <div class="gi-flex flex flex-row justify-between w-full max-[575px]:flex-col">
                        ...
                        <div class="self-center gi-header-logo max-[575px]:mb-[15px]">
                            <div class="header-logo text-left">
                                <a href="{{ url('/index') }}"><img src="assets/img/logo/logo.png" alt="Site Logo"
                                        class="w-[144px] max-[1199px]:w-[130px] max-[991px]:w-[120px] max-[767px]:w-[100px] "></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
                        <!-- Header Search Start -->
                                            ...
                                            <li
                                                ...
                                                <ul
                                                    ...
                                                    <li><a href="{{ url('/about-us') }}"
                                                            ...
                                                            Us</a></li>
                                                    <li><a href="{{ url('/contact-us') }} class="transition-all
                                                            duration-[0.3s] ease-in-out leading-[20px] px-[20px]
                                                            py-[10px] font-normal text-[13px] text-[#777] capitalize
                                                            flex justify-between items-center
                                                            hover:text-[#5caf90]">Contact Us</a></li>
                                                    <li><a href="{{ url('/cart') }}"
                                                    ...
                                                    <li><a href="{{ url('/login') }} class="transition-all
                                                            duration-[0.3s] ease-in-out leading-[20px] px-[20px]
                                                            py-[10px] font-normal text-[13px] text-[#777] capitalize
                                                            flex justify-between items-center
                                                            hover:text-[#5caf90]">Login</a></li>
                        ...
                        <li class="relative">
                            ...
                            <ul
                                ...
                                <li><a href="{{ url('/terms-condition') }}"
                                        ...
                                        Condition</a></li>
                                <li><a href="{{ url('/privacy-policy') }} class="mb-[0] pl-[15px] pr-[0] py-[12px]
                                        capitalize block text-[14px] font-normal text-[#777]">Privacy Policy</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="min-[768px]:w-[50%] w-full px-[12px]">
                            ...
                            <ul class="gi-breadcrumb-list text-right max-[767px]:text-center">
                                <li
                                    ...
                                    <a href="index.html" class="relative text-[#4b5966]">Home</a>
                                </li>
                                <li
    ...
    <section class="gi-blog py-[40px] max-[767px]:py-[30px]">
        <div
            ...
            <div class="flex flex-wrap w-full px-[12px]">
                <div class="gi-blogs-rightside w-full">
                    <!-- Blog content Start -->
                    <div class="gi-blogs-content">
                        <div class="gi-blogs-inner">
                            <div class="flex flex-wrap mx-[-12px]">
                                <div class="min-[992px]:w-[33.33%] min-[768px]:w-[50%] w-full px-[12px]">
                                    <div class="gi-blog-item">
                                        <div
                                            class="blog-info transition-all duration-[0.3s] ease-in-out w-full mb-[24px] bg-[#fff] rounded-[5px]">
                                            <figure
                                                class="blog-img w-full h-auto m-[0] relative overflow-hidden rounded-[5px]">
                                                <a href="#"><img src="assets/img/blog/1.jpg" alt="news imag"
                                                        class="transition-all duration-[0.3s] ease-in-out rounded-[0] w-full h-full"></a>
                                            </figure>
                                            <div class="detail">
                                                <label class="mt-[20px] inline-block text-[13px] text-[#999]">June
                                                    30,2022 - <a href="#"
                                                ...
                                                <h3 class="mt-[10px] mb-[15px] p-[0] leading-[26px]"><a href="#"
                                                        ...
                                                        Guide: 5 Steps to Success.</a></h3>
                                                <p class="text-length mb-[16px] text-[14px] text-[#777]">"Lorem Ipsum
                                                    is simply dummy text of the printing
                                                    and typesetting
                                                    industry.</p>
                                                <div class="more-info">
                                                    <a href="{{ url('/blog-detail-left-sidebar') }}"
                                                        class="text-[#4b5966] text-[13px] flex items-center hover:bg-[#fff] hover:text-[#5caf90]">Read
                                                        More<i
                                                            class="gicon gi-angle-double-right transition-all duration-[0.3s] ease-in-out ml-[5px] text-[#4b5966] text-[13px] flex"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="min-[992px]:w-[33.33%] min-[768px]:w-[50%] w-full px-[12px]">
                                    <div class="gi-blog-item">
                                        <div
                                            ...
                                            <figure
                                                class="blog-img w-full h-auto m-[0] relative overflow-hidden rounded-[5px]">
                                                <a href="#"><img src="assets/img/blog/2.jpg" alt="news imag"
                                                        class="transition-all duration-[0.3s] ease-in-out rounded-[0] w-full h-full"></a>
                                            </figure>
                                            <div class="detail">
                                                <label class="mt-[20px] inline-block text-[13px] text-[#999]">April
                                                    02,2022 - <a href="#"
                                                        class="text-[#999] hover:text-[#5caf90]">Fruits</a></label>
                                                <h3 class="mt-[10px] mb-[15px] p-[0] leading-[26px]"><a href="#"
                                                        class="font-Poppins text-[#4b5966] text-[17px] font-medium leading-[22px]">Best
                                                        way to solve business deal issue.</a></h3>
                                                <p class="text-length mb-[16px] text-[14px] text-[#777]">"Lorem Ipsum
                                                    is simply dummy text of the printing
                                                    and typesetting
                                                    industry.</p>
                                ...
                                <div class="min-[992px]:w-[33.33%] min-[768px]:w-[50%] w-full px-[12px]">
                                    <div class="gi-blog-item">
                                        <div
                                            ...
                                            <figure
                                                class="blog-img w-full h-auto m-[0] relative overflow-hidden rounded-[5px]">
                                                <a href="#"><img src="assets/img/blog/3.jpg" alt="news imag"
                                                        class="transition-all duration-[0.3s] ease-in-out rounded-[0] w-full h-full"></a>
                                            </figure>
                                            <div class="detail">
                                                <label class="mt-[20px] inline-block text-[13px] text-[#999]">Mar
                                                    09,2022 - <a href="#"
                                                        class="text-[#999] hover:text-[#5caf90]">Vegetables</a></label>
                                                <h3 class="mt-[10px] mb-[15px] p-[0] leading-[26px]"><a href="#"
                                                        class="font-Poppins text-[#4b5966] text-[17px] font-medium leading-[22px]">31
                                                        customer service stats know in 2019.</a></h3>
                                                <p class="text-length mb-[16px] text-[14px] text-[#777]">"Lorem Ipsum
                                                    is simply dummy text of the printing
                                                    and typesetting
                                                    industry.</p>
                                ...
                                <div class="min-[992px]:w-[33.33%] min-[768px]:w-[50%] w-full px-[12px]">
                                    <div class="gi-blog-item">
                                        <div
                                            ...
                                            <figure
                                                class="blog-img w-full h-auto m-[0] relative overflow-hidden rounded-[5px]">
                                                <a href="#"><img src="assets/img/blog/4.jpg" alt="news imag"
                                                        class="transition-all duration-[0.3s] ease-in-out rounded-[0] w-full h-full"></a>
                                            </figure>
                                            <div class="detail">
                                                <label class="mt-[20px] inline-block text-[13px] text-[#999]">January
                                                    25,2022 - <a href="#"
                                                        class="text-[#999] hover:text-[#5caf90]">Fastfood</a></label>
                                                <h3 class="mt-[10px] mb-[15px] p-[0] leading-[26px]"><a href="#"
                                                        class="font-Poppins text-[#4b5966] text-[17px] font-medium leading-[22px]">Business
                                                        ideas to grow your business.</a></h3>
                                                <p class="text-length mb-[16px] text-[14px] text-[#777]">"Lorem Ipsum
                                                    is simply dummy text of the printing
                                                    and typesetting
                                                    industry.</p>
                                ...
                                <div class="min-[992px]:w-[33.33%] min-[768px]:w-[50%] w-full px-[12px]">
                                    <div class="gi-blog-item">
                                        <div
                                            ...
                                            <figure
                                                class="blog-img w-full h-auto m-[0] relative overflow-hidden rounded-[5px]">
                                                <a href="#"><img src="assets/img/blog/5.jpg" alt="news imag"
                                                        class="transition-all duration-[0.3s] ease-in-out rounded-[0] w-full h-full"></a>
                                            </figure>
                                            <div class="detail">
                                                <label class="mt-[20px] inline-block text-[13px] text-[#999]">December
                                                    10,2021 - <a href="#"
                                                        class="text-[#999] hover:text-[#5caf90]">Fruits</a></label>
                                                <h3 class="mt-[10px] mb-[15px] p-[0] leading-[26px]"><a href="#"
                                                        class="font-Poppins text-[#4b5966] text-[17px] font-medium leading-[22px]">Marketing
                                ...
                                <div class="min-[992px]:w-[33.33%] min-[768px]:w-[50%] w-full px-[12px]">
                                    <div class="gi-blog-item">
                                        <div
                                            ...
                                            <figure
                                                class="blog-img w-full h-auto m-[0] relative overflow-hidden rounded-[5px]">
                                                <a href="#"><img src="assets/img/blog/6.jpg" alt="news imag"
                                                        class="transition-all duration-[0.3s] ease-in-out rounded-[0] w-full h-full"></a>
                                            </figure>
                                            <div class="detail">
                                                <label class="mt-[20px] inline-block text-[13px] text-[#999]">August
                                                    08,2021 - <a href="#"
                                                        class="text-[#999] hover:text-[#5caf90]">Vegetables</a></label>
                                                <h3 class="mt-[10px] mb-[15px] p-[0] leading-[26px]"><a href="#"
                                                        class="font-Poppins text-[#4b5966] text-[17px] font-medium leading-[22px]">31
