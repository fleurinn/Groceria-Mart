...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:16 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="grow-[1] shrink-[0] basis-[0%] min-[992px]:hidden">
                        <div class="gi-header-bottons flex justify-end">
                            <div class="right-icons flex flex-row">
                                <!-- Header User Start -->
                                <a href="{{ url('/login') }}" class="gi-header-btn gi-header-user mr-[30px] transition-all duration-[0.3s] ease-in-out flex text-[#4b5966] w-[auto] items-center">
