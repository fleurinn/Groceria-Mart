...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/blog-detail-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:52 GMT -->
...
<body class="w-full h-full relative font-Poppins font-normal overflow-x-hidden">
        ...
        <div
            ...
            <div
                ...
                <div class="gi-nav-bar flex flex-row justify-between relative w-full px-[12px]">
                    ...
                    <!-- Main Menu Start -->
                    <div id="gi-main-menu-desk" class="w-full items-center min-[992px]:flex hidden">
                        <div class="nav-desk">
                                        ...
                                        <ul class="w-full flex justify-center flex-wrap pl-[0]">
                                                ...
                                                <ul
                                                    ...
                                                    <li class="dropdown position-static">
                                                        ...
                                                        <ul
                                                            ...
                                                            <li>
                                                                <a href="{{ url('/product-right-sidebar') }}"
                                                                    class="transition-all duration-[0.3s] ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">
                                                    ...
                                                    <li class="dropdown position-static">
                                                        ...
                                                        <ul
                                                            class="sub-menu sub-menu-child transition-all duration-[0.3s] ease-in-out mt-[15px] absolute z-[16] text-left opacity-0 invisible min-w-[205px] left-0 right-auto bg-[#fff] block rounded-[5px] border-[1px] border-solid border-[#eee] py-[5px]">
                                                            <li>
                                                                <a href="{{ url('/product-accordion-left-sidebar') }}"
                                                                    class="transition-all duration-[0.3s] ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">
                                                                    Left Sidebar
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="{{ url('/product-accordion-right-sidebar') }}"
                                                                    class="transition-all duration-[0.3s] ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">
                                                                    Right Sidebar
                                                                </a>
                                                            </li>
                                            ...
                                            <li
                                                ...
                                                <ul
                                                    ...
                                                    <li>
                                                        <a href="{{ url('/blog-right-sidebar') }}"
                                                            class="transition-all duration-[0.3s] ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">
                                                            Blog Right Sidebar
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('/blog-full-width') }}"
                                                            class="transition-all duration-[0.3s] ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">
                                                            Blog Full Width
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a href="{{ url('/blog-detail-right-sidebar') }}"
                                                            class="transition-all duration-[0.3s] ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">
                                                            Blog Detail Right Sidebar
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ url('/blog-detail-full-width') }}"
                                                            class="transition-all duration-[0.3s] ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">
                            ...
                            <ul
                                ...
                                <li class="relative">
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a href="{{ url('/shop-left-sidebar-col-4') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                Left sidebar 4 column
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/shop-right-sidebar-col-3') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                Right sidebar 3 column
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/shop-right-sidebar-col-4') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                Right sidebar 4 column
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/shop-full-width') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                Full width 4 column
                                            </a>
                                        </li>
                                ...
                                <li class="relative">
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a href="{{ url('/shop-banner-left-sidebar-col-4') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                Banner left sidebar 4 column
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/shop-banner-right-sidebar-col-3') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                        ...
                                        <li>
                                            <a href="{{ url('/shop-banner-full-width') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                ...
                                <li class="relative">
                                    ...
                                    <ul
                                        class="sub-menu w-full min-w-[auto] p-0 mb-[10px] static hidden visible transition-none opacity-[1]">
                                        <li>
                                            <a href="{{ url('/shop-full-width-col-3') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                3 Columns full width
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/shop-full-width-col-4') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                        ...
                                        <li>
                                            <a href="{{ url('/shop-full-width-col-6') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                6 Columns full width
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/shop-banner-full-width-col-3') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                Banner 3 Columns
                                            </a>
                                        </li>
                                ...
                                <li class="relative">
                                    ...
                                    <ul
                                        ...
                                        <li>
                                            <a href="{{ url('/shop-list-right-sidebar') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                Shop right sidebar
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/shop-list-banner-left-sidebar') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
                                                Banner left sidebar
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{{ url('/shop-list-banner-right-sidebar') }}"
                                                class="pl-[30px] py-[12px] block text-[14px] text-[#999] font-normal">
    ...
    <section class="gi-blog py-[40px] max-[767px]:py-[30px]">
        <div
            class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px] relative">
            <div class="flex flex-wrap w-full">
                <div class="gi-blogs-rightside w-full px-[12px]">
                    <!-- Blog content Start -->
                                            ...
                                            <div class="w-full px-[12px]">
                                                <div class="gi-text-leave">
                                                    <textarea placeholder="Message"
                                                        class="w-full h-[200px] mb-[30px] py-[15px] px-[20px] border-[1px] border-solid border-[#eee] rounded-[5px] outline-[0]"></textarea>
                                                    <a href="#"
                                                        class="gi-btn-2 transition-all duration-[0.3s] ease-in-out overflow-hidden text-center relative rounded-[5px] py-[10px] px-[15px] bg-[#5caf90] text-[#fff] border-[0] text-[14px] tracking-[0] font-medium inline-flex items-center hover:bg-[#4b5966] hover:text-[#fff]">Submit</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="footer-copy max-[991px]:mb-[15px]">
                                <div class="footer-bottom-copy">
                                    <div class="gi-copy text-[#777] text-[13px] tracking-[1px] text-center font-light">
                                        Copyright ©
                                        <a class="site-name text-[#5caf90]" href="{{ url('/index') }}">Grabit</a>
