...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/privacy-policy.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:59:00 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="w-full h-full relative font-Poppins font-normal overflow-x-hidden">
                ...
                <div class="w-full px-[12px]">
                    <div class="flex flex-wrap m-0 p-[15px] border-[1px] border-solid border-[#eee] rounded-b-[5px] border-t-[0] gi_breadcrumb_inner">
                        <div class="min-[768px]:w-[50%] w-full px-[12px]">
                            <h2 class="gi-breadcrumb-title text-[#4b5966] block text-[15px] font-Poppins leading-[22px] font-semibold my-[0] mx-auto capitalize max-[767px]:mb-[5px] max-[767px]:text-center">Privacy Policy</h2>
                        </div>
                        <div class="min-[768px]:w-[50%] w-full px-[12px]">
                            ...
                            <ul class="gi-breadcrumb-list text-right max-[767px]:text-center">
                                ...
                                <li class="gi-breadcrumb-item inline-block text-[14px] font-normal tracking-[0.02rem] leading-[1.2] capitalize active">Privacy Policy</li>
                            </ul>
    ...
    <section class="gi-terms-conditions py-[40px] max-[767px]:py-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            <div class="section-title-2 w-full mb-[20px] pb-[20px] flex flex-col justify-center items-center">
                <h2 class="gi-title mb-[0] font-manrope text-[26px] font-semibold text-[#4b5966] relative inline p-[0] capitalize leading-[1]"><span class="text-[#5caf90]">Privacy</span> Policy</h2>
            ...
            <div class="w-full flex flex-wrap">
                <div class="min-[992px]:w-[50%] w-full px-[12px]">
                    <div class="gi-common-wrapper p-[30px] border-[1px] border-solid border-[#eee] max-w-[1140px] my-[0] mx-auto bg-[#fff] rounded-[5px]">
                        <div class="gi-cgi-block w-full">
                            <div class="gi-cgi-block-inner">
                                <h5 class="gi-cgi-block-title mb-[10px] text-[18px] font-semibold text-[#4b5966] tracking-[0.01rem] leading-[1.2]">Welcome to Grabit Store.</h5>
                                <p class="mb-[30px] text-[#777] text-[14px] font-normal leading-[28px] tracking-[0.02rem]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. <b class="text-[#4b5966] font-medium">Lorem
                                    ...
                                    essentially unchanged. <b class="text-[#4b5966] font-medium">Lorem Ipsum is simply dutmmy text.</b></p>
                            </div>
                        </div>
                        <div class="gi-cgi-block w-full">
                            <div class="gi-cgi-block-inner">
                                <h5 class="gi-cgi-block-title mb-[10px] text-[18px] font-semibold text-[#4b5966] tracking-[0.01rem] leading-[1.2]">Grabit Websites</h5>
                                <p class="mb-[30px] text-[#777] text-[14px] font-normal leading-[28px] tracking-[0.02rem]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. <b class="text-[#4b5966] font-medium">Lorem
                                        Ipsum is simply dutmmy text</b> ever since the 1500s, when an unknown printer
                                    took a galley of type and scrambled it to make a type specimen book. It has survived
                                    not only five centuries, but also the leap into electronic typesetting, remaining
                        ...
                        <div class="gi-cgi-block w-full">
                            <div class="gi-cgi-block-inner">
                                <h5 class="gi-cgi-block-title mb-[10px] text-[18px] font-semibold text-[#4b5966] tracking-[0.01rem] leading-[1.2]">How browsing and vendor works?</h5>
                                <p class="mb-[30px] text-[#777] text-[14px] font-normal leading-[28px] tracking-[0.02rem]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. <b class="text-[#4b5966] font-medium">Lorem
                                        Ipsum is simply dutmmy text</b> ever since the 1500s, when an unknown printer
                                    took a galley of type and scrambled it to make a type specimen book. It has survived
                                    not only five centuries, but also the leap into electronic typesetting, remaining
                        ...
                        <div class="gi-cgi-block w-full">
                            <div class="gi-cgi-block-inner">
                                <h5 class="gi-cgi-block-title mb-[10px] text-[18px] font-semibold text-[#4b5966] tracking-[0.01rem] leading-[1.2]">Becoming an vendor</h5>
                                <p class="text-[#777] text-[14px] font-normal leading-[28px] tracking-[0.02rem]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. <b class="text-[#4b5966] font-medium">Lorem
                                        Ipsum is simply dutmmy text</b> ever since the 1500s, when an unknown printer
                                    took a galley of type and scrambled it to make a type specimen book. It has survived
                                    not only five centuries, but also the leap into electronic typesetting, remaining
                                    essentially unchanged. <b class="text-[#4b5966] font-medium">Lorem Ipsum is simply dutmmy text.</b></p>
                ...
                <div class="min-[992px]:w-[50%] w-full px-[12px] max-[991px]:mt-[30px]">
                    <div class="gi-common-wrapper p-[30px] border-[1px] border-solid border-[#eee] max-w-[1140px] my-[0] mx-auto bg-[#fff] rounded-[5px]">
                        <div class="gi-cgi-block w-full">
                            <div class="gi-cgi-block-inner">
                                <h5 class="gi-cgi-block-title mb-[10px] text-[18px] font-semibold text-[#4b5966] tracking-[0.01rem] leading-[1.2]">How browsing and vendor works?</h5>
