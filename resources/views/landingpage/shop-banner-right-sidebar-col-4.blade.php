...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/shop-banner-right-sidebar-col-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:43 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="w-full h-full relative font-Poppins font-normal overflow-x-hidden">
    ...
    <section class="gi-shop py-[40px] max-[767px]:py-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            ...
            <div class="flex flex-wrap w-full">
                <div class="gi-shop-rightside min-[992px]:w-[75%] min-[768px]:w-full w-full px-[12px]">
                    <!-- Shop Top Start -->
                ...
                <!-- Sidebar Area Start -->
                <div class="gi-shop-sidebar sticky top-[24px] min-[992px]:w-[25%] min-[768px]:w-full w-full max-[991px]:mt-[30px] px-[12px]">
                    <div id="shop_sidebar">
