...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/product-accordion-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:50 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="w-full h-full relative font-Poppins font-normal overflow-x-hidden">
    ...
    <section class="gi-single-product py-[40px] max-[767px]:py-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px] relative">
            <div class="flex flex-wrap w-full">
                <div class="gi-pro-rightside gi-common-rightside min-[992px]:order-[6] min-[768px]:order-[-1] min-[992px]:w-[75%] w-full px-[12px]">
                    <!-- Single product content Start -->
                    <div class="single-pro-block">
                        <div class="single-pro-inner">
                            <div class="w-full flex flex-wrap">
                                <div class="single-pro-img single-pro-img-no-sidebar w-[47.3%] relative pr-[12px] max-[991px]:w-full max-[991px]:max-w-[500px] max-[991px]:m-auto max-[991px]:px-[12px] max-[420px]:px-[0]">
                ...
                <!-- Sidebar Area Start -->
                <div class="gi-shop-sidebar min-[992px]:order-[-1] min-[768px]:order-[6] min-[992px]:w-[25%] w-full px-[12px] max-[991px]:mt-[30px]">
                    <div id="shop_sidebar">
