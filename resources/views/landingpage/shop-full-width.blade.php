...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/shop-full-width.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:41 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="w-full h-full relative font-Poppins font-normal overflow-x-hidden">
    ...
    <!-- Category section -->
    <section class="gi-category pt-[40px] max-[767px]:pt-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
                ...
                <div class="gi-shop-rightside w-full">
                    ...
                    <div class="shop-pro-content">
                        <div class="shop-pro-inner mx-[-12px]">
                            <div class="flex flex-wrap w-full">
                                <div class="min-[1200px]:w-[25%] min-[992px]:w-[33.33%] min-[421px]:w-[50%] max-[420px]:w-full px-[12px] gi-product-box pro-gl-content">
