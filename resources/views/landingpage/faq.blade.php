...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:15 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="w-full h-full relative font-Poppins font-normal overflow-x-hidden">
                ...
                <div class="w-full px-[12px]">
                    <div class="flex flex-wrap m-0 p-[15px] border-[1px] border-solid border-[#eee] rounded-b-[5px] border-t-[0] gi_breadcrumb_inner">
                        <div class="min-[768px]:w-[50%] w-full px-[12px]">
                            <h2 class="gi-breadcrumb-title text-[#4b5966] block text-[15px] font-Poppins leading-[22px] font-semibold my-[0] mx-auto capitalize max-[767px]:mb-[5px] max-[767px]:text-center">Faq Page</h2>
                        </div>
                        <div class="min-[768px]:w-[50%] w-full px-[12px]">
                            ...
                            <ul class="gi-breadcrumb-list text-right max-[767px]:text-center">
                                ...
                                <li class="gi-breadcrumb-item inline-block text-[14px] font-normal tracking-[0.02rem] leading-[1.2] capitalize active">Faq Page</li>
                            </ul>
    ...
    <section class="gi-faq py-[40px] max-[767px]:py-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
            <div class="section-title-2 w-full mb-[20px] pb-[20px] flex flex-col justify-center text-center px-[12px] items-center">
                <h2 class="gi-title mb-[0] font-manrope text-[26px] font-semibold text-[#4b5966] relative inline p-[0] capitalize leading-[1]">frequently asked <span class="text-[#5caf90]">questions</span></h2>
                <p class="max-w-[400px] mt-[15px] text-[14px] text-[#777] text-center leading-[23px]">Customer service management.</p>
            </div>
                ...
                <div class="min-[992px]:w-[50%] w-full px-[12px]">
                    <div class="gi-accordion style-1">
                        <div class="gi-accordion-item border-[#eee] overflow-hidden mb-[10px]">
                            <h4 class="gi-accordion-header m-[0] py-[15px] pl-[30px] pr-[35px] bg-[#f8f8fb] text-[#4b5966] text-[16px] leading-[28px] font-medium relative font-Poppins border-[1px] border-solid border-[#eee] rounded-[5px] tracking-[0.01rem] max-[767px]:text-[15px]">
                                What is the multi vendor services?
                            </h4>
                            <div class="gi-accordion-body show py-[15px] text-[14px] text-[#777] leading-[24px] hidden">Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. Lorem
                                Ipsum has been the industry's standard <code class="text-[#5caf90] text-[14px] font-semibold">dummy text</code> ever since the 1500s,
                                when an
                        ...
                        <div class="gi-accordion-item border-[#eee] overflow-hidden mb-[10px]">
                            ...
                            <div class="gi-accordion-body py-[15px] text-[14px] text-[#777] leading-[24px] hidden">Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. Lorem
                                Ipsum has been the industry's standard <code class="text-[#5caf90] text-[14px] font-semibold">dummy text</code> ever.
                                unknown printer took a galley of type and scrambled it to make a type specimen book.
                            </div>
                        </div>
                        <div class="gi-accordion-item border-[#eee] overflow-hidden mb-[10px]">
                        ...
                        <div class="gi-accordion-item border-[#eee] overflow-hidden">
                            <h2 class="gi-accordion-header m-[0] py-[15px] pl-[30px] pr-[35px] bg-[#f8f8fb] text-[#4b5966] text-[16px] leading-[28px] font-medium relative font-Poppins border-[1px] border-solid border-[#eee] rounded-[5px] tracking-[0.01rem] max-[767px]:text-[15px]">
