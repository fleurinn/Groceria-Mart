...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/blog-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:51 GMT -->
...
<body class="w-full h-full relative font-Poppins font-normal overflow-x-hidden">
    ...
    <header class="gi-header bg-[#fff] z-[14] max-[991px]:z-[16] relative">
        ...
        <div class="header-top py-[10px] text-[#777] bg-[#f8f8fb]">
                    ...
                    <div class="grow-[1] shrink-[0] basis-[0%] hidden min-[992px]:block">
                        <div class="header-top-right-inner flex justify-end">
                            <a class="gi-help pl-[20px] text-[13px] text-[#777] tracking-[0.7px] font-normal hover:text-[#5caf90]"
                                href="{{ url('/faq') }}">Help?</a>
                            <a class="gi-help pl-[20px] text-[13px] text-[#777] tracking-[0.7px] font-normal hover:text-[#5caf90]"
                                href="{{ url('/track-order') }}">Track Order?</a>
                            <!-- Language Start -->
                    ...
                    <div class="grow-[1] shrink-[0] basis-[0%] min-[992px]:hidden">
                        <div class="gi-header-bottons flex justify-end">
                            <div class="right-icons flex flex-row">
                                ...
                                <a href="{{ url('/wishlist') }}"
                                    class="gi-header-btn gi-wish-toggle mr-[30px] relative transition-all duration-300 ease-in-out flex text-[#4b5966] w-auto items-center">
                                ...
                                <!-- Header Cart Start -->
                                <a href="javascript:void(0)"
                                    class="gi-header-btn gi-cart-toggle mr-7 relative transition-all duration-300 ease-in-out flex text-[#4b5966] w-auto items-center">
                                </a>
                                <div class="header-icon relative flex">
            ...
            <div
                ...
                <div
                    ...
                    <div class="gi-nav-bar flex flex-row justify-between relative w-full px-[12px]">
                                                ...
                                                <div class="tab-list w-full flex flex-wrap">
                                                    <div class="px-[12px] grow-[1]">
                                                        ...
                                                        <ul class="cat-list">
                                                            ...
                                                            <li><a href="{{ url('/shop-left-sidebar-col-3') }}shop-left-sidebar-col-3.html"
                                                    ...
                                                    <div class="px-[12px] grow-[1]">
                                                        ...
                                                        <ul class="cat-list">
                                                            <li><a href="{{ url('/shop-left-sidebar-col-3') }}"
                                                                    ...
                                                                    Juice</a></li>
                                                            <li><a href="s{{ url('/shop-left-sidebar-col-3') }}"
                        ...
                        <!-- Main Menu Start -->
                        <div id="gi-main-menu-desk" class="w-full hidden items-center min-[992px]:block">
                            <div class="nav-desk">
            ...
            <div class="gi-mobile-menu-overlay hidden w-full h-screen fixed top-[0] left-[0] bg-[#000000cc] z-[16]">
            </div>
                        ...
                        <ul>
                            ...
                            <li class="dropdown relative">
                                ...
                                <ul
                                    ...
                                    <li><a href="b{{ url('/log-detail-right-sidebar') }}"
                                            class="mb-[0] pl-[15px] pr-[0] py-[12px] capitalize block text-[14px] font-normal text-[#777]">Blog
                        ...
                        <div class="min-[768px]:w-[50%] w-full px-[12px]">
                            ...
                            <ul class="gi-breadcrumb-list text-right max-[767px]:text-center">
                                <li
                                    ...
                                    <a href="{{ url('/index') }}" class="relative text-[#4b5966]">Home</a></li>
                                <li
                                ...
                                <div
                                    ...
                                    <div class="gi-sidebar-block-detial">
                                        <h5 class="gi-blog-title leading-[1.2] mb-[6px]"><a
                                                href="{{ url('/blog-detail-left-sidebar') }}"
