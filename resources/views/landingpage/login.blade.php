...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:16 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="gi-flex flex flex-row justify-between w-full max-[575px]:flex-col">
                        ...
                        <div class="self-center gi-header-logo max-[575px]:mb-[15px]">
                            <div class="header-logo text-left">
                                <a href="{{ url('/login') }}"><img src="assets/img/logo/logo.png" alt="Site Logo" class="w-[144px] max-[1199px]:w-[130px] max-[991px]:w-[120px] max-[767px]:w-[100px] "></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
                        <!-- Header Search Start -->
                            ...
                            <div class="gi-login-form">
                                <form action="#" method="post" class="flex flex-col">
                                    <span class="gi-login-wrap flex flex-col">
                                        ...
                                        <input type="text" name="name" placeholder="Enter your email add..." class="mb-[27px] px-[15px] bg-transparent border-[1px] border-solid border-[#eee] rounded-[5px] text-[#777] text-[14px] outline-[0] h-[50px]" required>
                                    </span>
                                    <span class="gi-login-wrap flex flex-col">
