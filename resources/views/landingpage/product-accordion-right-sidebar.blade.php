...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/product-accordion-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:50 GMT -->
<head>
    <meta charset="UTF-8">
...
<body class="w-full h-full relative font-Poppins font-normal overflow-x-hidden">
    ...
    <section class="gi-single-product py-[40px] max-[767px]:py-[30px]">
        <div class="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px] relative">
            <div class="flex flex-wrap w-full">
                <div class="gi-pro-rightside gi-common-rightside min-[992px]:w-[75%] w-full px-[12px]">
                    <!-- Single product content Start -->
                    <div class="single-pro-block">
                        <div class="single-pro-inner">
                            <div class="w-full flex flex-wrap">
                                <div class="single-pro-img single-pro-img-no-sidebar w-[47.3%] max-[991px]:w-full max-[991px]:max-w-[500px] max-[991px]:m-auto relative pr-[12px] max-[991px]:px-[12px] max-[420px]:px-[0]">
                                ...
                                <div class="single-pro-desc single-pro-desc-no-sidebar w-[52.7%] pl-[12px] max-[991px]:pl-[0] max-[991px]:mt-[30px] max-[991px]:w-full">
                    ...
                    <div class="gi-accordion style-1 gi-single-pro-tab-content overflow-hidden bg-[#fff] text-left p-[30px] border-[1px] border-solid border-[#eee] text-[#202020] text-[18px] tracking-[0] leading-[1.6] rounded-[5px]">
                        <div class="gi-accordion-item border-[#eee] overflow-hidden mb-[10px]">
                            <h4 class="gi-accordion-header max-[767px]:text-[15px] m-[0] py-[15px] pl-[15px] pr-[35px] bg-[#f8f8fb] text-[#4b5966] text-[16px] leading-[28px] font-medium relative font-Poppins border-[1px] border-solid border-[#eee] rounded-[5px] tracking-[0.01rem]">
                                Product Detail
                            </h4>
                            ...
                            <div class="gi-accordion-body py-[15px] text-[14px] text-[#777] leading-[24px] hidden">
                                <div class="gi-single-pro-tab-moreinfo">
                                    <div class="gi-product-vendor">
                                        ...
                                        <div class="gi-detail">
                                            <ul class="mb-[15px] pl-[24px] ">
                                                <li class="mb-[4px] text-[15px] text-[#777] tracking-[0.02rem] leading-[24px] list-disc max-[575px]:mb-[10px]"><span class="mr-[25px] min-w-[150px] text-[15px] text-[#4b5966] inline-block font-medium tracking-[0.02rem] max-[575px]:w-full">Phone No. :</span> +00 987654321</li>
                                                <li class="mb-[4px] text-[15px] text-[#777] tracking-[0.02rem] leading-[24px] list-disc max-[575px]:mb-[10px]"><span class="mr-[25px] min-w-[150px] text-[15px] text-[#4b5966] inline-block font-medium tracking-[0.02rem] max-[575px]:w-full">Email. :</span> Example@gmail.com</li>
                                                <li class="mb-[4px] text-[15px] text-[#777] tracking-[0.02rem] leading-[24px] list-disc max-[575px]:mb-[10px]"><span class="mr-[25px] min-w-[150px] text-[15px] text-[#4b5966] inline-block font-medium tracking-[0.02rem] max-[575px]:w-full">Address. :</span> 2548 Broaddus Maple Court, Madisonville KY 4783, USA.</li>
                                            </ul>
                ...
                <!-- Sidebar Area Start -->
                <div class="gi-shop-sidebar min-[992px]:w-[25%] w-full px-[12px] max-[991px]:mt-[30px]">
                    <div id="shop_sidebar">
...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/product-accordion-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:51 GMT -->
</html>