...
<!-- Mirrored from maraviyainfotech.com/projects/grabit-tailwind/grabit-tailwind/blog-detail-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2025 01:58:52 GMT -->
                                            ...
                                            <li
                                                ...
                                                <ul
                                                    ...
                                                    <li class="dropdown position-static">
                                                        ...
                                                        <ul
                                                            ...
                                                            <li><a href="{{ url('product-left-sidebar') }}"
                                                                    class="transition-all duration-300 ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">Product
                                                                    left sidebar</a></li>
                                                    ...
                                                    <li class="dropdown position-static">
                                                        ...
                                                        <ul
                                                            ...
                                                            <li><a href="{{ url('product-accordion-left-sidebar') }}"
                                                                    class="transition-all duration-300 ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">Left
                                                                    sidebar</a></li>
                                                            <li><a href="{{ url('product-accordion-right-sidebar') }}"
                                                                    class="transition-all duration-300 ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">Right
                                                                    sidebar</a></li>
                                                        </ul>
                                                    </li>
                                                    ...
                                                    <li><a href="{{ url('product-accordion-full-width') }}"
                                                            class="transition-all duration-300 ease-in-out leading-[20px] px-[20px] py-[10px] font-normal text-[13px] text-[#777] capitalize flex justify-between items-center hover:text-[#5caf90]">Accordion
                                                            full width</a></li>
                                                </ul>
                                            </li>
                                            <li
    ...
    <section class="gi-blog py-[40px] max-[767px]:py-[30px]">
        <div
            ...
            <div class="flex flex-wrap w-full">
                ...
                <!-- Sidebar Area Start -->
                <div
                    class="min-[992px]:w-[33.33%] w-full gi-blogs-sidebar gi-blogs-leftside max-[991px]:mt-[30px] px-[12px]">
                    <div
                            ...
                            <div class="gi-blog-block-content gi-sidebar-dropdown">
                                ...
                                <div
                                    ...
                                    <div class="gi-sidebar-block-detial">
                                        ...
                                        <a
                                            href="{{ url('/blog-left-sidebar') }}"class="text-[14px] text-[#5caf90] w-full leading-[20px] font-normal capitalize cursor-pointer flex justify-between">-
                                            Fruits</a>
                                    </div>
                                </div>
                                <div
